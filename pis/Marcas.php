...
<link rel="stylesheet" href="css/Marcas.css" type="text/css" media="all" />
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
						...
						<li class="active"><a href="Marcas.php" class="hyper"><span>Marcas</span></a></li>
	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="sliderfig">
				<ul id="flexiselDemo1">			
					<li>
						<img src="images/Marcas/Acer.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/alienware.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/asus.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/Corsair.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/Dell.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/Hitachi.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/Hp.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/marvo.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/msi.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/sam.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/terrax.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/TSH.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/amd.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/intel.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/apple.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/giga.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/razer.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/Marcas/TSH.png" alt=" " class="img-responsive" />
					</li>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
						...
						<li class="active"><a href="Marcas.php?id=<?php echo $id;?>" class="hyper"><span>Marcas</span></a></li>
