			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<figcaption class="roboto-medium text-center">
						<?php echo $_SESSION['nombre_adm'] ?> <br><small class="roboto-condensed-light">SMARTZONE</small>
					</figcaption>
				</figure>
...
<form method="post" action="">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-users fa-fw"></i> &nbsp; LISTA DE CLIENTES
				</h3>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="NuevoClienteAdmin.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO CLIENTE</a>
					</li>
					<li>
						<a class="active" href="ListarClienteAdmin.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
					</li>
				</ul>	
			</div>
				...
				<div class="table-responsive">
					...
					foreach($datos as $row =>$item)
					{
						echo "<tr>";
							...
							echo "<td><a class='btn btn-success' href='ActualizarClienteAdmin.php?id=".$item['idcliente']."'><i class='fas fa-sync-alt'></i></a> <a class='btn btn-warning' href='EliminarClienteAdmin.php?id=".$item['idcliente']."'><i class='far fa-trash-alt'></i></a></td>";
						echo "</tr>";
					}
					echo "</table>";
					echo "</center>";
