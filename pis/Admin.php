		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<img src="assets/avatar/compu.png" class="img-fluid" alt="Avatar"></a>
...
<form method="post" action="">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-dashcube fa-fw"></i> &nbsp; BIENVENIDO ADMINISTRAD@R AL CONTROL DE PRODUCTOS 
				
				</h3>
			<img src="https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2018/07/fondo-pantalla-wallpaper-movil.jpg" alt="">
