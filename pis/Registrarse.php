...
if (isset($_POST["btnregistrar"]))
{
    ...
    $rpassword=trim($_POST["txtrpassword"]);
    ...
    if ($password1==$rpassword)
    {
        ...
        if ($valor==true)
        {
            ...
            $nombres="";
            $apellidos="";
            $resultado2=utf8_encode ("<label style='color:#990066'>Ex&iacute;to al Registrarse</label>");
        }
        else
        {
        $resultado2=utf8_encode ("<label style='color:#990066'> Error al Registrarse </label>");
        }
    }
    else
    {
    $resultado2=utf8_encode ("<label style='color:#990066'> Las Contrase&ntilde;as No Coinciden </label>");
    }
				...
				<div class="form-w3agile">
					...
					<form action="" method="post">
						<div class="key">
							...
							<input  type="text"  name="txtnombres" required=""  placeholder="Nombres">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text"  name="txtapellidos" required=""  placeholder="Apellidos">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-envelope" aria-hidden="true"></i>
							<input  type="text"  name="txtemail1"  required=""  placeholder="E-mail">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password"  name="txtpassword1"  required="" placeholder="Contraseña">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password" name="txtrpassword" required="" placeholder="Repetir Contraseña">
							<div class="clearfix"></div>
						</div>
						<?php echo $resultado2; ?>
						<input type="submit" name="btnregistrar" value="CREAR">
					</form>
				</div>
			</div>
		</div>
