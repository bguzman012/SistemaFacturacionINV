    ...
    if($password == $password1)
    {
		...
		if($valor==true)
		{
			...
			$password1="";
		        ...
		        echo "<script>";
		        echo "window.location.href = 'ListarClienteAdmin.php';";
		        echo "</script>";    
		}
		else
		{
...
else
{
    ...
    $registro= $objcli->buscar();
    $idcliente=$registro["idcliente"];
    $nombres=$registro["nombres"];
    $apellidos=$registro["apellidos"];
    $email=$registro["email"];
    $password=$registro["password"];
    $password1=$registro["password"];
}
?>
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a href="BusquedaClienteAdmin.php"><i class="fas fa-search fa-fw"></i> &nbsp; BÚSQUEDA DE CLIENTES</a>
					</li>
				</ul>	
			</div>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_nombre" class="bmd-label-floating">Id CLiente</label>
										<input type="text" value="<?php echo $idcliente; ?>" disabled="disabled" class="form-control" name="txtidcliente" id="txtidcliente" maxlength="50">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
