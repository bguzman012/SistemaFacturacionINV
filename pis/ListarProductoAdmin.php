		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="ListarProductoAdmin.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PRODUCTOS</a>
					</li>
				</ul>	
			</div>
				...
				<div class="table-responsive">
					...
					foreach($datos as $row =>$item)
					{
						...
						echo "<tr>";
							...
							echo "<td>" . $item["nombreproducto"] . "</td>";
							...
							echo "<td>" . $v . "</td>";
							echo "<td><a class='btn btn-success' href='ActualizarProductoAdmin.php?id=".$item['idproducto']."'><i class='fas fa-sync-alt'></i></a> <a class='btn btn-warning' href='EliminarProductoAdmin.php?id=".$item['idproducto']."'><i class='far fa-trash-alt'></i></a></td>";
						echo "</tr>";
					}
					echo "</table>";
					echo "</center>";
