...
class imprimirFacturaCompra
{
	...
	public function traerImpresionFactura()
	{
		...
		$respuestaCompraDetalle = ControladorCompras::ctrMostrarComprasDetalle($respuestaCompra["id"]);
		...
		// $codigo = json_decode($respuestaCompra['codigo'], true); No se Usa
	...
	<table>
		...
		<tr>
			...
			<td style="background-color:white; width:110px; text-align:center; color:black"><br><br>FACTURA <br> NRO: $valorCompra</td>
...
EOF;
		...
		foreach ($respuestaCompraDetalle as $key => $item) {
...
$factura = new imprimirFacturaCompra();
