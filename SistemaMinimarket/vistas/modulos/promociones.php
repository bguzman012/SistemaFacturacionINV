  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarPromociones">
...
<div id="modalAgregarPromociones" class="modal fade" role="dialog">
    ...
    ?>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoURL" placeholder="Pegue aqui la url de la imagen " required>
