...
require "controladores/compras.controlador.php";
require "controladores/proveedores.controlador.php";
require "controladores/inventario.controlador.php";
...
require "modelos/inventario.modelo.php";
require "modelos/ventas.modelo.php";
require "modelos/compras.modelo.php";
