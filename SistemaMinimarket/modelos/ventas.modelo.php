...
class ModeloVentas{
	...
	static public function mdlIngresarVenta($tabla, $datos){
		...
		$stmt = $conexion ->prepare("INSERT INTO $tabla(codigo, id_cliente, id_vendedor, impuesto, neto, total, metodo_pago) VALUES (:codigo, :id_cliente, :id_vendedor, :impuesto, :neto, :total, :metodo_pago)");
